...
title: Grid
position: 3
css_path: utilities/grid.css
description: To use the grid system, add the class .nak-grid to an element, component, or page layout. Each grid is independent of other nested grids.
type: utility
right_content:
right_code: |
